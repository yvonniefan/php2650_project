...
The root node of a survival tree can be split through maximizing the survival difference between the child nodes.
In the resulting tree, the most different individuals will be separated and the homogenous ones will be kept in the same node.
Individuals in the same nodes will have similar survival rates [2-4].
